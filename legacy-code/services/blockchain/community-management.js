...
const CommunityManagementPage = () => {
    const post = allContents.find((post)=> post._raw.flattenedPath = "community-management");
    ...
    return (
        <Layout>
            ...
            <main className='bg-indigo-50/50'>
                <div>
                        ...
                        <div className='px-5'>
                            <div className="flex flex-col ">
                                <div className=" px-4 py-8 items-center text-center ">
                                    <h2 className="text-3xl py-2 font-medium text-gray-600">Avail the Best Community Management Services</h2>
                                ...
                                <div className="flex flex-col md:px-40">
                                    <div className="flex flex-col text-xl lg:px-40">
                                        ...
                                        <div className="text-gray-600 text-lg">
                                            <ol className=' list-outside list-disc px-10 bg-indigo-50/50 rounded-lg'>
                                        ...
                                        <h2 className='text-2xl mt-3 font-medium text-gray-600 text-left'>List of Questions Required to Get Started with the ICO Community Management (Frequently Asked Questions)</h2>
                                        <div className="text-gray-600 text-lg">
                                            {/* <br /> */}
