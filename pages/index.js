            ...
            <div className="flex flex-col w-full lg:px-16 py-8 font-serif">
              <div className="lg:flex">
                <div className="flex flex-col p-2 lg:w-1/2 border-4 rounded-xl lg:h-96 justify-center ">
                  ...
                  <div className="flex justify-center">
                    <div className="p-1"><Link href="/services/it"><a className="bg-sptheme-lightgreen text-white py-1 px-4 text-lg rounded-md hover:bg-emerald-800">Check All Services</a></Link></div>
                    <div className="p-1"><Link href="/pricing"><a className=" bg-gray-400 text-black py-1 px-4 text-lg rounded-md hover:bg-zinc-50">Start Your Project</a></Link></div>
                  </div>
                </div>
                <div className="flex flex-col p-2 lg:w-1/2 border-4 rounded-xl lg:h-96 justify-center ">
                  ...
                  <div className="flex justify-center">
                    <div className="p-1"><Link href="/services/crypto"><a className="bg-sptheme-lightgreen text-white py-1 px-4 text-lg rounded-md hover:bg-emerald-800">Check All Services</a></Link></div>
                    <div className="p-1"><Link href="/pricing"><a className=" bg-gray-400 text-black py-1 px-4 text-lg rounded-md hover:bg-zinc-50">Start Your Project</a></Link></div>
                  </div>
                </div>
              </div>
              <div className="lg:flex">
                <div className="flex flex-col p-2 lg:w-1/2 border-4 rounded-xl lg:h-96 justify-center ">
                  ...
                  <div className="flex justify-center">
                    <div className="p-1"><Link href="/services/digital-marketing"><a className="bg-sptheme-lightgreen text-white py-1 px-4 text-lg rounded-md hover:bg-emerald-800">Check All Services</a></Link></div>
                    <div className="p-1"><Link href="/pricing"><a className=" bg-gray-400 text-black py-1 px-4 text-lg rounded-md hover:bg-zinc-50">Start Your Project</a></Link></div>
                  </div>
                </div>
                <div className="flex flex-col p-2 lg:w-1/2 border-4 rounded-xl lg:h-96 justify-center">
                  ...
                  <div className="flex justify-center">
                    <div className="p-1"><Link href="/services/content"><a className="bg-sptheme-lightgreen text-white py-1 px-4 text-lg rounded-md hover:bg-emerald-800">Check All Services</a></Link></div>
                    <div className="p-1"><Link href="/pricing"><a className=" bg-gray-400 text-black py-1 px-4 text-lg rounded-md hover:bg-zinc-50">Start Your Project</a></Link></div>
                  </div>
                </div>
              </div>
