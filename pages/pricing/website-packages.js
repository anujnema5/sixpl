...
const webPackage = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>Website Packages - SixPL</title>
            ...
            <main className=''>
                <div className='mt-7 sm:mt-20 lg:-mb-16 -mb-20 pt-10 lg:px-0 px-2.5'>
                    <h1 className='lg:text-[1.9rem] px-2 text-2xl font-bold tracking-tight text-gray-600 sm:text-3xl text-center'>Affordable Web Design Packages</h1>
                </div>
