            ...
            <main>
                <div>
                    <div className="flex flex-col font-serif">
                        ...
                        <div className=' px-4 py-10 lg:px-14 bg-slate-200 font-serif'>
                            <div className=' flex flex-col items-center'>
                                <div className=' py-4 text-center text-3xl text-sptheme-darkgreen'>Blockchain Technology and Cryptocurrency is Redefining the Future of Commerce</div>
                                <div className='  flex flex-col lg:flex-row'>
                                    <div className=' p-4 lg:px-8  flex flex-col lg:w-1/2'>  
                                        <div className=' py-4 text-2xl text-center text-sptheme-darkgreen'>You Lead The Change</div>
                                    ...
                                    <div className=' p-4 lg:px-8 flex flex-col lg:w-1/2'>
                                        <div className=' py-4 text-2xl text-center text-sptheme-darkgreen'>We Power That Change</div>
                                        <div className=' text-xl text-gray-700'>
                                            <p>
                        ...
                        <div className='  '>
                            <div className="flex flex-col font-serif">
                                <div>
                                    <div className="flex flex-col px-4 py-8 items-center text-center ">
                                        <h2 className="text-3xl py-4 text-sptheme-darkgreen">Power Your Next Generation Product with Solid Content</h2>
                                        <p className="text-2xl py-2">Communicate Your Vision, Attract More Investors and Gain Confidence of Yoiur Potential Customers</p>
                                    </div>
                                </div>
                                <div>
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">SEO Friendly Content</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Technical Content</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Marketing Content</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Video Script</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">ICO/IDO/IEO White Paper</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Investors Deck</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                            ...
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Social Media Content</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Technical Documentation</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Dapp, NFT Content</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NFT Marketplace Content</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div className="flex flex-col lg:flex-row">
                                <div className="lg:w-1/2 px-4 py-14">
                                    <div className="pb-4 text-center text-3xl text-sptheme-darkgreen">Start Your Custom Cryptocurrency Content Development Project in 4 Easy Steps</div>
                                    <div>
                            ...
                            <div>
                                <div className='lg:px-40 py-10 font-serif '>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How much time you will take to finish my project?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>We deliver the projects as per the deadline set by the clients.</div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you accept payments in BTC/Cryptocurrency?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>Due to heavy taxes on crypto transactions in India, we are currently accepting payments only in fiat currency.</div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you have technical expertise in Blockchain/Crypto?</div>
                                    ...
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Can you share a few samples you have done in crypto domain?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
