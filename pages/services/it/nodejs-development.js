                    ...
                    <div className="flex flex-col font-serif">
                        <div className=' relative'>
                            ...
                            <div>
                                <div className="flex flex-col px-4 py-8 items-center text-center">
                                    <h1 className="text-4xl py-4">Develop Fast, Secure, Scalable & Real time NodeJS Application</h1>
                                    <p className="text-2xl py-2">Collaborate with us to develop scalable and high-speed NodeJS applications to enhance your business value</p>
                                </div>
                            </div>
                            <div>
                                <div className="flex flex-col lg:flex-row">
                                    <div className="lg:w-1/2 px-4 py-14">
                                        <div className="pb-4 text-center text-3xl">Hire the top NodeJS development company</div>
                                        <div>
                                                ...
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">Front-end & Back-end Development</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2 ">
                                                            ...
                                                            <div className="py-2 text-2xl">Quicker Market Launch</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">Fast & Secure Development Process</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">Flexible Engagement Model</div>
                                                        </div>  
                                                    </div>   
                                                </div>
                        ...
                        <div className='  '>
                            <div className="flex flex-col font-serif">
                                <div>
                                    <div className="flex flex-col px-4 py-8 items-center text-center ">
                                        <h2 className="text-3xl py-4 text-sptheme-darkgreen">Accentuate Your Business Application with NodeJS Development</h2>
                                        <p className="text-2xl py-2">Hire our NodeJS for scalable, fast, and single-threaded real-time applications to automate your business processes</p>
                                    </div>
                                </div>
                                <div>
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">RESTful API Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Real-time Application Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Internationalization</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Package Manager</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Consulting Services</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Web App Development</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Mobile App Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Migration</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Support & Maintenance</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Dashboard Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NodeJS Application Deployment</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Dockerized NodeJs Development</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div className="flex flex-col lg:flex-row">
                                <div className="lg:w-1/2 px-4 py-14">
                                    <div className="pb-4 text-center text-3xl text-sptheme-darkgreen">You are just 4 steps away from starting your NodeJS development</div>
                                    <div>
                                        <div className="flex flex-col">
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Scope of Work</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2 ">
                                            ...
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Project Miletone</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Starting the NodeJS Development Workflow</div>
                                                    </div>  
                                                </div>   
                                            </div>
                            ...
                            <div>
                                <div className='lg:px-40 py-10 font-serif '>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Which type of applications can you build on NodeJS?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>We can build NodeJS app of any complexity. In the past, we have developed eCommerce apps, social media apps, gaming apps, chat applications, and even streaming apps using NodeJS</div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                    ...
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How skilled are your NodeJS developers?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            We have a team of certified and experienced NodeJS developers who have delivered a number of projects for several businesses from start-ups to established ones.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How much time will you take to complete a typical NodeJS project?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            The time depends on the complexity of the project. We have worked on ongoing projects as well as those which have been taken seven to 180 days to get completed.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How can we track the progress of NodeJS development?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            We ensure to make timely updates on project development and practice transparency so that the clients can track the workflow and offer their input on further changes.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you have an in-house team?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            Yes. We have a dedicated and in-house team of NodeJS developers who will handle your projects.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How does NodeJS development benefit my business?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            The beneficial aspects of NodeJS include scalability, greater responsiveness, and non-blocking architecture that helps you build real-time back-end applications. This helps in business enhancement with high-performing applications.
                                        </div>
                                    </div>
                                </div>
                            </div>
