                        ...
                        <div className=' flex flex-col text-white bg-cover bg-[url(/images/dm-icons/pngtopheader.png)]'>
                            <div>
                                <div className="flex flex-col px-4 py-8 items-center text-center">
                                    <h1 className="text-4xl py-4">Build a Blazing Fast Application with React NextJS</h1>
                                    <p className="text-2xl py-2">Use Modern NextJS Framework to Build Modern, Powerful, Secure, Fast, & Progressive Web Applications. </p>
                                </div>
                            </div>
                            <div>
