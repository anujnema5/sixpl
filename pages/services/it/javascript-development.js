                    ...
                    <div className="flex flex-col font-serif">
                        <div className=' relative'>
                            ...
                            <div>
                                <div className="flex flex-col px-4 py-8 items-center text-center">
                                    ...
                                    <p className="text-2xl py-2">Leverage the Power of JavaScript & Bring the Front-end and Back-end Together</p>
                                </div>
                            </div>
                            <div>
                                <div className="flex flex-col lg:flex-row">
                                    <div className="lg:w-1/2 px-4 py-14">
                                        <div className="pb-4 text-center text-3xl">Hire the Best JavaScript Development Company</div>
                                        <div>
                                                ...
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">Front-end JavaScript Development</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2 ">
                                                            ...
                                                            <div className="py-2 text-2xl">Back-end JavaScript Development</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">Desktop JavaScript Application</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">JavaScript Libraries & Frameworks</div>
                                                        </div>  
                                                    </div>   
                                                </div>
                        ...
                        <div className='  '>
                            <div className="flex flex-col font-serif">
                                <div>
                                    <div className="flex flex-col px-4 py-8 items-center text-center ">
                                        <h2 className="text-3xl py-4 text-sptheme-darkgreen">Build Faster at a Lower Cost with JavaScript</h2>
                                        <p className="text-2xl py-2">Let our JavaScript experts help you create a seamless user experience with attractive and unique interfaces for your business</p>
                                    </div>
                                </div>
                                <div>
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">ECMAScript 6 Support</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">User Interface Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Backend Development with NodeJS</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">NPM Package Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">JavaScript Project Consulting</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Enterprise Applications Development</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">JavaScript Library Integration</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Web Design and Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Mobile App Development</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">eCommerce/CRM/ERP Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">CMS Development</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">API Development</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div className="flex flex-col lg:flex-row">
                                <div className="lg:w-1/2 px-4 py-14">
                                    <div className="pb-4 text-center text-3xl text-sptheme-darkgreen">Start Your Custom JavaScript Development Project in 4 Easy Steps</div>
                                    <div>
                                        <div className="flex flex-col">
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Business Goals</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2 ">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Requirement Specifications</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Miletsone Development</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                            ...
                            <div>
                                <div className='lg:px-40 py-10 font-serif '>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>What is the significance of JavaScript development?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>JavaScript is a highly interactive technology that aids in front-end and back-end development. It is greatly helpful in creating fast and multi-functional web pages. These features come in handy for any business that is expecting to reach more clients and increase its value.</div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>What is the cost of JavaScript development services?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>The cost of a JavaScript development project depends on the complexity of the project, scope of work, amount of features to be incorporated, client’s nationality, and the platform used. </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How do you support international clients?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            We have the facilities for 24*7 support and assistance so that we can cater to the needs of international clients.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>What are the means to ensure timely project delivery?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            We always assure a prompt connection with the client and instant support to ensure reliability. The clients are duly notified of the progress of development and are given the benefit of making intermittent changes. Thus, the timely delivery of the project is ensured with our transparent workflow.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you offer end-to-end development solutions?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            Yes. Our services comprise the overall JavaScript development process from planning the architecture to front-end and back-end design and development followed by maintenance and support.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you have an in-house team?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            Yes. We have a dedicated and in-house team of JavaScript developers who will handle your project.
                                        </div>
                                    </div>
                                </div>
                            </div>
