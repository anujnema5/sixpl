                    ...
                    <div className="flex flex-col font-serif">
                        <div className=' relative'>
                            ...
                            <div>
                                <div className="flex flex-col px-4 py-8 items-center text-center">
                                    <h1 className="text-4xl py-4">Start ROI Driven Campaigns with our Google Ads Manaagement Services</h1>
                                    <p className="text-2xl py-2">Get More Customers in Your Marketing Budget</p>
                                </div>
                            </div>
                            <div>
                                <div className="flex flex-col lg:flex-row">
                                    <div className="lg:w-1/2 px-4 py-14">
                                        <div className="pb-4 text-center text-3xl">Hire #1 Google Ads Manaagement Company</div>
                                        <div>
                                                ...
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">7 Days Free Trial for New Accounts</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2 ">
                                                            ...
                                                            <div className="py-2 text-2xl">Low Cost Per Click</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col items-center lg:flex-row justify-center">
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">74% More Conversions</div>
                                                        </div>
                                                    </div>
                                                    <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                        <div className="flex flex-col items-center text-center p-2">
                                                            ...
                                                            <div className="py-2 text-2xl">End-to-End Campaign Manaagement</div>
                                                        </div>  
                                                    </div>   
                                                </div>
                        ...
                        <div className='  '>
                            <div className="flex flex-col font-serif">
                                <div>
                                    <div className="flex flex-col px-4 py-8 items-center text-center ">
                                        <h2 className="text-3xl py-4 text-sptheme-darkgreen">Start Getting Customers who are Looking for Your Services</h2>
                                        <p className="text-2xl py-2">Let our Google Ads Experts Maximize Return on Your Marketing Investment</p>
                                    </div>
                                </div>
                                <div>
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Google Ads for E-commerce/B2B/B2C </div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                            ...
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Google Ads for Gmail/Chrome/Maps</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">YouTube Ads Management</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">App Install Campaigns</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Daily Campaign Monitoring & Optimization</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Google Ads on Top News Sites</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Quality Score Management</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                        ...
                                        <div className="flex flex-col items-center lg:flex-row justify-center">
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Retargeting</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Bid Strategy Management</div>
                                                </div>
                                            </div>
                                            <div className="px-4 py-4 lg:w-1/3 lg:h-52 ">
                                                <div className="flex flex-col items-center text-center p-2">
                                                    ...
                                                    <div className="py-2 text-2xl text-gray-700">Google Merchant Center</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex flex-col items-center lg:flex-row justify-center text-center py-14 lg:px-24'>
                                        <div className='flex flex-col lg:w-1/3 my-4 mx-0.5 hover:border-4 hover:border-sptheme-darkgreen hover:rounded-xl'>
                                            ...
                                            <div className='w-full'>
                                                <div className='bg-slate-200 p-2'>
                                                    <div className='p-2 border-b-2 border-slate-300 text-xl font-semibold'>Google Ads Management Activities</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of Ad Groups/Campaign - 1</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of RSAs(Responsive Search Ads) per Ad Group - 1</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Keywords Per Ad Group - 100</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Image Extension - No</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Campaign Editing Frequency - Weekly</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Audience Management for Remarketing - No</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Landing Page Creation - No</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Custom Domain - No</div>
                                        ...
                                        <div className='flex flex-col lg:w-1/3 my-4 mx-0.5 hover:border-4 hover:border-sptheme-darkgreen hover:rounded-xl'>
                                            ...
                                            <div className='w-full'>
                                                <div className='bg-slate-200 p-2'>
                                                    <div className='p-2 border-b-2 border-slate-300 text-xl font-semibold'>Google Ads Management Activities</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of Ad Groups/Campaign - 2</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of RSAs(Responsive Search Ads) per Ad Group - 2</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Keywords Per Ad Group - Unlimited</div>
                                                    <div className='p-1 border-b-2 border-slate-300 '>Image Extension - Yes</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Campaign Editing Frequency - Weekly</div>
                                                    <div className='p-1 border-b-2 border-slate-300 '>Audience Management for Remarketing - Yes</div>
                                                    <div className='p-1 border-b-2 border-slate-300 '>Landing Page Creation - Google My Business</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Custom Domain - No</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Hosting - No</div>
                                                </div>
                                            </div>
                                        ...
                                        <div className='flex flex-col lg:w-1/3 my-4 mx-0.5 hover:border-4 hover:border-sptheme-darkgreen hover:rounded-xl'>
                                            ...
                                            <div className='w-full'>
                                                <div className='bg-slate-200 p-2'>
                                                    <div className='p-2 border-b-2 border-slate-300 text-xl font-semibold'>Google Ads Management Activities</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of Ad Groups/Campaign - 3</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>No of RSAs(Responsive Search Ads) per Ad Group - 3</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Keywords Per Ad Group - Unlimited</div>
                                                    <div className='p-1 border-b-2 border-slate-300 '>Image Extension - Yes</div>
                                                    <div className='p-1 border-b-2 border-slate-300'>Campaign Editing Frequency - Daily (Weekdays)</div>
                                                    <div className='p-1 border-b-2 border-slate-300 '>Audience Management for Remarketing - Yes</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Landing Page Creation Yes</div>
                                                    <div className='p-1 border-b-2 border-slate-300 text-gray-400'>Custom Domain - Yes</div>
                                            ...
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Set Campaign Goals</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2 ">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Landing Page Audit</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="flex flex-col items-center lg:flex-row justify-center">
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Conversion Setup</div>
                                                    </div>
                                                </div>
                                                <div className="px-4 py-4 lg:w-1/2 lg:h-52">
                                                    <div className="flex flex-col items-center text-center p-2">
                                                        ...
                                                        <div className="py-2 text-2xl text-gray-700">Campaign Initiation</div>
                                                    </div>  
                                                </div>   
                                            </div>
                            ...
                            <div>
                                <div className='lg:px-40 py-10 font-serif '>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Can you explain the pricing structure?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            Two types of charges are applicable to generate leads thriugh our Google Ads Management Services as mentioned below: <br/>
                                            <ol className=' list-outside list-decimal px-8'>
                                                <li> A direct payment to Google to show ads on Google - This is the budget you decide. The final result will depend on this budget. </li>
                                                <li> SixPL Campaign Management Fee - Applicable as per the services offered as mentioned in above packages. </li>
                                            </ol>
                                            
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Can you run Google Ads Campaign in our Timezone?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>Yes. Our Google Ads Experts work round the clock to cater to clients in different timezones.</div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>Do you have experience in our industry?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            We have been offering result-oriented Google Ads Management services to our clients since 2012. We have served more than 400 clients from almost all industries.
                                            Please tell us your industry and we will share relevant portfolio.
                                        </div>
                                    </div>
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                    ...
                                    <div className='flex flex-col bg-gray-100 rounded-md p-4 my-8'>
                                        <div className='font-semibold py-2 px-4 text-stone-800'>How much return can I expect from our Google Ads investment?</div>
                                        <div className='text-lg py-2 px-4 text-gray-700'>
                                            The return on marketing investment depends on the products/services we advertise. Some of our clients have reported even 1000% return on their ad spend. Tell us more about your offerings so that we can estimate the return on your ad spend.
                                        </div>
                                    </div>
