...
// import { digitalmarketingPack, facebookInstagramAdsManagement, googleAdsManagement, socialMediaPacks, tiers } from './allPackages'
import { digitalmarketingPack, facebookInstagramAdsManagement, googleAdsManagement, socialMediaPacks} from './allPackages'
...
export const services = {
    nextjsDevelopment: {
        slug: 'it/nextjs-development',
        title: "Hire a Next JS Developer | Get Next JS Support - SixPL",
        description: "Build a Next JS Full Stack Progressive Web App Now. Hire a top Next JS Development Company and get reliable Next JS services & Deployment Solutions. SixPL",
        mainSection: {
    ...
    nodejsDevelopment: {
        slug: 'it/nodejs-development',
        title: "Hire a Node JS Developer | Get Node JS Support - SixPL",
        description: "Build a Node JS Full Stack Progressive Web App Now. Hire a top Node JS Development Company and get reliable Node JS services & Deployment Solutions. SixPL",
    ...
    reactDevelopment: {
        slug: "it/best-react-developers",
        title: "Hire Best React developers - SixPL",
        description: "Hire top Reactjs developers from the best Reactjs development company. 24*7 support. Fullstack & Frontend Reactjs development services. Stable React Web Development.",
        mainSection: {
    ...
    javascriptDevelopment: {
        slug: "it/javascript-development",
        title: "Javascript Development | Hire top JavaScript Developers",
        description: "JavaScript Development company with 100+ years of accumulative JavaScript development experience. Hire front-end, backend & full-stack JavaScript developers now",
        mainSection: {
    ...
    webAppDevelopment: {
        slug: "it/web-app-development",
        title: "Web Application Development Company - SixPL",
        description: "Build real-time, secure & fast web applications with our web development services. Hire web apps developer instantly. Avail app development services - SixPL",
        mainSection: {
    ...
    webDesignDevelopment: {
        slug: "it/website-design-development",
        title: "Web Design & Development Company - SixPL",
        description: "Avail web design & development services. Hire top website development company & avail quality web development services 24*7. Get all website design services.",
        mainSection: {
    ...
    hireDeveloper: {
        slug: "it/hire-developers",
        title: "Hire Developers, Top 1% Web Developer - SixPL",
        description: "Hire developers, web developer, full stack developers, front end and back end developers on a freelance, part-time or full-time basis. Flexible working hours.",
        mainSection: {
    ...
    digitalMarketingFullServices: {
        slug: "digital-marketing/full-service",
        title: "Hire #1 Digital Marketing Agency - SixPL",
        description: "Avail quality digital marketing services from a top digital marketing agency. Generate more leads at lower cost. Check pricing & packages. 7-Days Free Trial",
        mainSection: {
    ...
    searchEngineOptimization: {
        ...
        title: "Best SEO Company in Delaware - SixPL",
        description: "SixPL is the best SEO Company in Delaware, USA. Offering on-page and off-page optimization, link building, local SEO and much more. Get Free SEO Audit",
        mainSection: {
    ...
    socialMediaMarketing: {
        ...
        title: "Social Media Marketing Agency | SMM Services - SixPL",
        description: "Social media marketing services from a top social media marketing company. Get more followers, engagement, traffic & sales from our SMM services. SixPL",
        mainSection: {
    ...
    googleAdsManagement: {
        slug: "digital-marketing/google-ads-management",
        title: "Google Ads Management | PPC Agency | PPC Services - SixPL",
        description: "Google Ads management services designed to generate more ROI from Google ads campaign. Avail PPC services, Remarketing Ads from top PPC agency, SixPL",
        mainSection: {
    ...
    facebookInstagramAdsManagement: {
        slug: "digital-marketing/facebook-instagram-ads-management",
        title: "Facebook & Instagram Ads Management Services - SixPL",
        description: "Facebook Ads Management services designed to generate more leads & sales. Facebook & Instagram Lead generation ads. Business Manager services. SixPL",
        mainSection: {
    ...
    web3Development: {
        ...
        title: "Hire Best Web3 Developers - SixPL",
        description: "Hire top 1% web3 developers & launch you next project on blockchain. Build scalable & compatible decentralized apps (Dapps) today. SixPL",
        mainSection: {
    ...
    cryptoContent: {
        slug:"blockchain/cryptocurrency-content",
        title: "Blockchain & Cryptocurrency Content Writer - SixPL",
        description: "Avail blockchain & crypto content writing services and communicate your complex blockchain-based business model to the target audience. Crypto Content Services",
        mainSection: {
    ...
    communityManagement: {
        slug: "blockchain/community-management",
        mainSection: {
    ...
    contentWriting: {
        slug: "content/content-writing",
        title: "Content Writing Services | Content Writing Agency",
        description: "Hire #1 content writing agency. Get all types of content writing services. Hire content writers who are subject matter experts. 100% original content",
        mainSection: {
            ...
            tags: [
                { svg: "", title: "End-to-End Solutions" },
                { svg: "", title: "Quick Turnaround Time" },
                { svg: "", title: "Fast Solutions" },
                { svg: "", title: "Diverse Content style" }
            ],
    ...
    academicWriting: {
        slug: "content/academic-writing",
        title: "Academic Writing Services - SixPL",
        description: "Avail academic writing services and shine at university or school. Our academic services include course curriculum development, essay writing, paper writing, etc.",
        mainSection: {
    ...
    sopWriting: {
        slug: "content/sop-writing",
        title: "SOP Writing Services | Hire Best SOP Writers -Sixpl",
        mainSection: {
    ...
    resumeWriting: {
        slug: "content/resume-writing",
        title: "Resume Writing Services | Professional Resume Writers",
        description: "Best resume writing services from professional resume writers. Resume designing helps you craft a perfect resume for your dream job. Resume help. SixPL",
        mainSection: {
