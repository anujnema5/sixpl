...
export const metadata = genPageMetaData({ title: `Blockchain & Cryptocurrency Content Writer - ${siteMetadata.headerTitle}`, description: "Avail blockchain & crypto content writing services and communicate your complex blockchain-based business model to the target audience. Crypto Content Services" })
