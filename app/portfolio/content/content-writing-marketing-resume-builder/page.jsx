                    ...
                    <div className=' flex flex-col my-10 mx-4 py-4 '>
                        <div>
                            <div className='py-10 px-4'>
                                <h1 className=' text-3xl text-indigo-800 font-semibold text-center'>Content Writing & Marketing Services for a Leading Resume Builder Platform</h1>
                            </div>
                            <div className='px-4'>
                                <p className='text-gray-800 text-center'>Portfolio {">"} Content Services</p>
                            </div>
                        </div>
                        <div className=' flex flex-col lg:mx-40'>
                            <div className='px-4 py-4'>
                                <h2 className='text-2xl text-indigo-700 font-medium'>Overview</h2>
                                <p className=' text-lg mt-1'>SixPL team delivered a 2000 SEO-friendly high quality blogs in 2 months.</p>
                            </div>
                            <div className='px-4 py-4'>
                                <h2 className='text-2xl text-indigo-700 font-medium'>Client</h2>
                                <p className=' text-lg mt-1'>A popular UK-based SaaS platfom that enables job seekers to create perfect resume in minutes. </p>
                            </div>
                            <div className='px-4 py-4'>
                                <h2 className='text-2xl text-indigo-700 font-medium'>Industry</h2>
                                <p className=' text-lg mt-1'>Software-as-a-service (SAAS), IT, Human Resources</p>
                            </div>
                            <div className='px-4 py-4'>
                                <h2 className='text-2xl text-indigo-700 font-medium'>Project Goal</h2>
                                <p className=' text-lg mt-1'>To research relevant keywords and write high-quality SEO-friendly blogs to attract more traffic from search engines  </p>
                            </div>
                            <div className='px-4 py-4'>
                            ...
                            <div className='px-4 py-4'>
                                ...
                                <p className=' text-lg mt-1'>We delivered 2000 articles in 65 days. Today, these articles attract more than 2.4 million month global visitors.</p>
                                <ol className='list-disc list-outside pl-8 py-4 text-lg mt-1'>
