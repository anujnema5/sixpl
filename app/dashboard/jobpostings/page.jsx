        ...
        const fetchData = async () => {
            ...
            try {
                ...
                querySnapshot.forEach((doc) => {
                    list.push({...doc.data(), opened: false})
                });
                setJobs(list)
                console.log(list)
            } catch (error) {
                                        ...
                                        <tr key={plan.id} className=''>
                                            ...
                                            >
                                                <div className="font-medium text-gray-900">
                                                    {plan.jobPosition}
                                                    {plan.isCurrent ?
                                                        <span className="ml-1 border-2 border-red-700 text-indigo-600"></span> : null}
                                                </div>
                                                <div className="mt-1 flex flex-col text-gray-500 sm:block lg:hidden">
                                                    <span>
                                                        {plan.totalPositions} / {plan.location}
                                                    </span>
                                            ...
                                            >
                                                {/* <div className="hidden">{plan.jobType}/mo</div> */}
                                                <div className="hidden sm:block">{plan.jobType}</div>
                                            </td>
                                            <td
                                                className={classNames(
                                                    planIdx === 0 ? '' : 'border-t border-transparent',
                                        ...
                                        {plan.opened &&
                                            (<tr className='px-10'>
                                                <div className='px-4'>
                                                    ...
                                                    <h1 className='w-[80vw] lg:w-full lg:text-2xl font-medium'>{plan.jobPosition}</h1>
                                                    <p className='text-gray-600 mt-3'>{plan.jobRoleDescription}</p>
                                                    ...
                                                    {plan.otherDescription && <p className='mt-6 ml-2 text-gray-600'>{plan.otherDescription}</p>}
