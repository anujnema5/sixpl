                                ...
                                <div>
                                    <div className="flex flex-col md:px-40">
                                        <div className="flex flex-col text-xl  lg:px-40">
                                            ...
                                            <h2 className='text-2xl font-medium text-gray-600 py-4 text-left'>Hire an ICO White Paper Writer and Kick off your Project</h2>
                                            <p className="text-lg text-gray-700">
                                            ...
                                            <h2 className='text-2xl font-medium text-gray-600 py-4 text-left'>White Paper – A Prerequisite to a successful Crypto Project</h2>
                                            <p className="text-lg text-gray-700">
                                            ...
                                            <h2 className='text-2xl font-medium text-gray-600 py-4 text-left'>Inspire Your Audience and Get Backing of your Users</h2>
                                            <p className="text-lg text-gray-700">
                                            ...
                                            <h2 className='text-2xl font-medium text-gray-600 py-4 text-left'>ICO White Paper Template</h2>
                                            ...
                                            <h2 className='text-2xl font-medium text-gray-600 py-4 items-start'>ICO White Paper Writing Services from Blockchain Experts</h2>
                                            <p className="text-lg text-gray-700">
